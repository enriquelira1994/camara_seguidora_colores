    ...
    if ret:
        ...
        for c in contornos:
            ...
            if area > 6000:
                ...
                if x < 200:
                    print("Mueve a la izquierda 100%")
                    ser.write(b"izq1\n")
                elif 420 > x >= 200:
                    print("Mueve a la izquiera 60%")
                    ser.write(b"izq2\n")
                elif 520 > x >= 420:
                    print("Mueve a la izquiera 30%")
                    ser.write(b"izq3\n")
                    # move to center
                elif 520 > x >= 650:
                    print("Mueve al centro")
                    ser.write(b"ctr\n")
                elif 650 > x >= 860:
                    print("Mueve a la derecha 30% 60%")
                    ser.write(b"der3\n")
                elif 860 > x >= 1080:
                    print("Mueve a la derecha 60%")
                    ser.write(b"der2\n")
                elif x >= 1080:
                    print("Mueve a la derecha 100%")
                    ser.write(b"der1\n")
